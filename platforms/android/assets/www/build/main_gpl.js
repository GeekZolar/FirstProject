...
var app = {
    ...
    initScrollDetection: function() {
        $(document).height() > $(window).height() ? $("dashboard").addClass("has-scroll") : $("body").removeClass("has-scroll")
    },
    ...
    initMenuTrigger: function() {
        $(".navbar__action--menu, .navbar__action--close").on("click", function(i) {
            i.preventDefault(), $("nav").fadeToggle(400), $("dashboard").toggleClass("menu-open"), $(".navbar__action--menu").toggleClass("navbar__action--is-hidden"), $(".navbar__action--close").toggleClass("navbar__action--is-hidden")
        })
    }
};
$(function() {
