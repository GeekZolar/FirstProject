! function(i) {
    ...
    e = function() {
        ...
        var i, e, t = this;
        if (t.dragging = !1, t.interrupted = !1, t.shouldClick = t.touchObject.swipeLength > 10 ? !1 : !0, void 0 === t.touchObject.curX) return !1;
...
var app = {
    initFunction: function() {
        var i = $(".form__item input:not([type=radio]), .form__item select, .form__item textarea"),
            e = function(i) {
                i.val() ? i.addClass("is-filled") : i.removeClass("is-filled")
            };
        i.each(function() {
            e($(this))
        }), i.on("blur", function() {
    ...
    initSpacing: function() {
        var i = $(".heading");
        if (i.length) {
            var e = $(".heading").height() + 60,
                t = $(".start-bottom");
            t.css("paddingTop", e + "px")
        }
    },
    initScrollDetection: function() {
        $(document).height() > $(window).height() ? $("ion-content.dashboard").addClass("has-scroll") : $("ion-content.dashboard").removeClass("has-scroll")
    },
    ...
    initImageHeight: function() {
        var i = $(".playlist__col--img img").height();
        $(".playlist__col--txt").height(i)
    },
    ...
    initMenuTrigger: function() {
        $(".navbar__action--menu, .navbar__action--close").on("click", function(i) {
            i.preventDefault(), $("nav").fadeToggle(400), $("ion-content.dashboard").toggleClass("menu-open"), $(".navbar__action--menu").toggleClass("navbar__action--is-hidden"), $(".navbar__action--close").toggleClass("navbar__action--is-hidden")
        })
    }
};
$(function() {
    app.initFunction(), app.initSpacing(), app.initDialogPositioning(), app.initScrollDetection(), app.initPinInput(), app.initImageHeight(), app.initMenuTrigger(), $(window).resize(function() {
        app.initScrollDetection(), app.initDialogPositioning(), app.initImageHeight()
